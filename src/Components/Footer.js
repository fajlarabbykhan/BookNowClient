...
const Footer = () => {
  return (
    <>
      <footer class="footer p-10 bg-base-300 text-base-content w-full max-w-[1024px]">
        <div>
        ...
        <div>
          ...
          <div className="flex mt-2 gap-6">
            ...
            <div class="grid grid-flow-col gap-4">
              <a className="text-[#3b6cd4] cursor-pointer">
                <svg
              ...
              <a className="text-[#f53838] cursor-pointer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
