  ...
  return (
    <div className="w-full max-w-[1024px] grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 p-2 ">
      <div className="flex flex-col	gap-2">
        ...
        />
        <span className="font-bold	 text-[#333]">Aparthotel Stare Miasto</span>
      ...
      <div className="flex flex-col	gap-2">
        <img
          ...
          className="w-full h-[250px] object-cover"
        />
        <span className="font-bold	 text-[#333]">Comfort Suites Airport</span>
      ...
      <div className="flex flex-col	gap-2">
        <img
          ...
          className="w-full h-[250px] object-cover"
        />
        <span className="font-bold	 text-[#333]">Four Seasons Hotel</span>
      ...
      <div className="flex flex-col	gap-2">
        <img
          ...
          className="w-full h-[250px] object-cover"
        />
        <span className="font-bold	 text-[#333]">Hilton Garden Inn</span>
